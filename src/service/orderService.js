...
export const deleteOrderCpt = (orderId, orderDetailId) =>
  axiosInstance.delete(`order/${orderId}?orderDetailId=${orderDetailId}`)
...
export const getOpenOrderByOrderId = (orderId , verificationType , providerId ) => axiosInstance.get(`openOrder/dob/${orderId}/${verificationType}/${providerId}`)

export const validateOrderDob = (orderId, validationDetail) =>
  axiosInstance.post(`openOrder/dob/${orderId}`, validationDetail)

export const getSMSOrderDetails = (orderId) => axiosInstance.post(`openOrder/smscontent/${orderId}`, {})

export const getOrdersByPatientId = (patientId, searchQuery) =>
  axiosInstance.post(`order/orderList/${patientId}`, searchQuery)

export const getOrderType = () => axiosInstance.get(`order/orderType`)

export const getViewReceipt = (orderId) =>
  axiosInstance.post(`openorder/viewReceipt`, orderId, { responseType: 'arraybuffer' })
