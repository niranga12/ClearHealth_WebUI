                ...
                <div className="login-footer">
                  <div className="row   ">
                    <div className="col-md-6">
                      ...
                      <span className="support-clearhealth pad-20">support@clearhealthinc.com</span>
                    </div>
                    <div className="col-md-6 log-foot-phone">
                      <span className="phone"></span> <span className="support-clearhealth">(888) 918-2522</span>
                    </div>
                  </div>
                </div>
              </div>
