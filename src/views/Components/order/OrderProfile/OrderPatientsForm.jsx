				...
				<div className='row'>
					<div className='col-md-4'>
						<div className='form-group'>
							...
							<input className='form-control-sm' type='text' {...register('patient.firstName')} onBlur={() => setstateChange(!stateChange)} />
					...
					<div className='col-md-4'>
						<div className='form-group'>
							...
							<input className='form-control-sm' type='text' {...register('patient.middleName')} onBlur={() => setstateChange(!stateChange)} />
					...
					<div className='col-md-4'>
						<div className='form-group'>
							...
							<input className='form-control-sm' type='text' {...register('patient.lastName')} onBlur={() => setstateChange(!stateChange)} />
