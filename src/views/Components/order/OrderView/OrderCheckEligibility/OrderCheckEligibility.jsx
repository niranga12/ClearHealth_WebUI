      ...
      {(benefitPlan || inPatient) && (
        <div className="card  cover-content pt-2 ">
          ...
          <div className="card-body pb-0">
            <div className="">{benefitPlan && <HealthBenefitPlan healthBenefitPlan={benefitPlan} />}</div>
            <div className="">{inPatient && <HospitalInPatient hospitalInPatient={inPatient} />}</div>
          </div>
        </div>
      )}
    </div>
