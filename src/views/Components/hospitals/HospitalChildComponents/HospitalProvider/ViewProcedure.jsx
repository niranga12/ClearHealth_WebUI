  ...
  const subColumns = useMemo(
    () => [
...

      {
        ...
        disableSortBy: true,
        Cell: ({ row }) => (
          <div className=" text-black text-right"> {CurrencyFormat(Number(row.original.facility), true)} </div>
        )
      },
      {
        ...
        disableSortBy: true,
        Cell: ({ row }) => (
          <div className=" text-black text-right"> {CurrencyFormat(Number(row.original.physician), true)} </div>
        )
      },
      {
        ...
        disableSortBy: true,
        Cell: ({ row }) => (
          <div className=" text-black text-right"> {CurrencyFormat(Number(row.original.anesthesia), true)} </div>
        )
      },

      {
        ...
        disableSortBy: true,
        Cell: ({ row }) => (
          <div className=" text-black text-right"> {CurrencyFormat(Number(row.original.pathology), true)} </div>
        )
      },

      {
        ...
        disableSortBy: true,
        Cell: ({ row }) => (
          <div className=" text-black text-right"> {CurrencyFormat(Number(row.original.clearFee), true)} </div>
        )
      },
      {
        ...
        disableSortBy: true,
        Cell: ({ row }) => (
          <div className=" text-black text-right"> {CurrencyFormat(Number(row.original.total), true)} </div>
        )
      }
    ],
    []
