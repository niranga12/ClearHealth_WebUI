...
import { deleteProviderFeeSchedule, getProviderFeeSchedule, getSpecialityList, saveProviderFeeSchedule } from 'src/service/providerService';
...
const ProviderEditFeeSchedules = ({ edit, partyRoleId,updateChanges }) => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            const list = await getProviderFeeSchedule(partyRoleId);
...
export default ProviderEditFeeSchedules
