  ...
  return (
    <div className="p-4">
      <form onSubmit={handleSubmit(providerFormSubmit)}>
        ...
        <div className="row mb-3">
          <div className="col-md-6">
            <div className="form-group">
              ...
              <select
                {...register('healthSystemPartyRoleId')}
          ...
          <div className="row mb-3">
            <div className="col-md-4">
              <div className="mt-1 ml-4">
                <input
                  type="radio"
                  checked={groupSelection === 'Individual'}
                  value="Individual"
                  ...
                  disabled={isEdit}
                />{' '}
                <span className="ml-3 mr-5">Individual</span>{' '}
                <input
                  type="radio"
                  checked={groupSelection === 'Group'}
                  value="Group"
                  name="IndividualGroup"
                  className="form-check-input mr-3"
                  onChange={handleIndividualGroup}
                  disabled={isEdit}
                />{' '}
                <span className="ml-3 mr-3">Group </span>{' '}
              </div>
            </div>
          </div>
        ) : (
        ...
        <div className="row mb-3">
          ...
          <div className="col-md-4">
            <h5 className="font-weight-bold mt-1">
              ...
              <input type="checkbox" className="form-check-input" onChange={handleHospitalChecked} />{' '}
              <span className="small">Use Hospital Address</span>{' '}
            </h5>
          ...
          <div className="col-md-4">
            <h5 className="font-weight-bold mt-1">
              <span className="pr-5">Billing Address </span>{' '}
              <input type="checkbox" className="form-check-input" onChange={handleBillingChecked} />{' '}
        ...
        {isFeeSchedule == true && (
          <ProviderAddFeeSchedules
            edit={isEdit}
            partyRoleId={saveProviderId}
            isFeeSchedule={isFeeSchedule}
            hosId={hospitalId}
