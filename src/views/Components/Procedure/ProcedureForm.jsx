      ...
      <div className="divider ">
        <div className="row">
          <div className="col-md-12 pt-3 pb-2">
            <h4 className="procedure-add-title">
        ...
        <div className="row">
          ...
          <div className="col-md-2">
            <div className="form-group">
              ...
              <span className="currency-sign">$</span>
              <input
                className="form-control-sm currecy-input"
                type="number"
                {...register('procedure.facility')}
                onBlur={(e) => {
                  setstate(!state)
                }}
              />
          ...
          <div className="col-md-2">
            <div className="form-group">
              ...
              <span className="currency-sign">$</span>
              <input
                className="form-control-sm currecy-input disable-field"
                type="number"
                {...register('procedure.clearFee')}
              />
            </div>
          </div>
          ...
          <div className="col-md-4 pt-4 mt-1">
            <button
              className={`btn  w-75 m-auto text-white ${liveStatus ? 'btn-secondary' : 'btn-primary'}`}
        ...
        <div className="row">{data.serviceType !== ServiceTypeEnum.Radiology ? dynamicFormControl() : ''}</div>
      </div>
    </>
  )
}
