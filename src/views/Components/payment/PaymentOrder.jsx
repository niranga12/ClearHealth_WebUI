        ...
        <div className="row">
          <div className="col-md-6">
            <div className="form-group">
              ...
              <input
                ...
                type="text"
                {...register('order.patientName')}
                onBlur={() => setFieldChange(!fieldChange)}
              />
          ...
          <div className="col-md-6">
            <div className="form-group">
              ...
              <InputMask
                {...register('order.contactPhone')}
                mask={MaskFormat.phoneNumber}
                alwaysShowMask={EnableMaskPhone(true, getValues('order.contactPhone'))}
                className="form-control-sm"
              />
          ...
          <div className="col-md-6">
            <div className="form-group">
              ...
              <input
                className="form-control-sm"
                type="text"
                {...register('order.billingAddress1')}
                onBlur={() => setFieldChange(!fieldChange)}
              />
          ...
          <div className="col-md-6">
            <div className="form-group">
              ...
              <input
                className="form-control-sm"
                type="text"
                {...register('order.billingAddress2')}
                onBlur={() => setFieldChange(!fieldChange)}
              />
