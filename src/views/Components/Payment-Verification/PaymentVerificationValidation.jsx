		...
		const fetchData = async () => {
			...
			try {
				...
				if (result.data.message == ServiceMsg.OK) {
					...
					console.log(result.data.data.orderPatientDetails);
				}
			} catch (error) {
						...
						<div className='card boxshadow p-3 radius-1'>
							<div className='row'>
								<div className='col-md-12'>
									...
									<p className='col-md-6 m-auto text-center p-2 font-lato-bold'>Enter your unique patient billing ID to verify the procedure and the payment</p>
								</div>
								<div className='col-md-12'>
								...
								<div className='col-md-6  offset-md-3  text-center'>
									<input type='text' className='form-control-sm ' onChange={handleIdChange} placeholder='Enter Id Here' />
